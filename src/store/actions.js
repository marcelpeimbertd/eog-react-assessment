...
// Drone Metrics Command and Events
export const FETCH_METRICS = "COMMAND/FETCH_MECTRICS";
export const DRONE_METRICS_RECEIVED = 'EVENT/DRONE_METRICS_RECEIVED';